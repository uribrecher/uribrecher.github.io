...
sidebar:
  ...
  - title: תואר ראשון במדעי המחשב
    image: /assets/images/co-sci.png
header:
...
הפילטרים שהתרגלתי לחיות לצידם הוסרו ויכולתי לראות את הפער הגדול
בין החלום הרוחני לבין המציאות. הכאב הזה מעבר ליכולותי.
מתוך הפחד להתמודד איתו יצרתי לעצמי מציאות הרסנית שהביאה למשבר זוגי עמוק.
...
מי שפגע בי. זה להבין שמשבר אמון זה לא סוף הדרך ושתמיד אפשר לתקן.
